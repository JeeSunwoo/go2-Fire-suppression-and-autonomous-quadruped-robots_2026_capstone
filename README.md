...
The following repositories are required but are **not included** in this repository because they are maintained as external projects.

Clone them into the `src/` directory before building the workspace.
...
This repository contains original project code developed by **Team R.O.I**.

External dependencies (Unitree ROS2, Hesai LiDAR ROS Driver, and Intel RealSense ROS) remain the property of their respective authors and are distributed under their own licenses.
